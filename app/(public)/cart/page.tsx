...
const CartPage = () => {
  ...
  return (
    <>
      ...
      />
      <section className="bg-slate-100 py-4 px-6 md:px-28">
        <div className="grid grid-cols-1 md:grid-cols-4 container mx-auto py-8 md:max-w-7xl gap-4 ">
          <div className="col-span-3 flex flex-col bg-white p-6 rounded-md shadow gap-6 space-y-2">
            <h4 className="text-xl md:text-2xl font-semibold">Shopping Cart</h4>
            <hr />
            <div className="">
                ...
                <tbody>
                  {products.map((cart) => {
                    ...
                    return (
                      ...
                      >
                        <td className="flex items-center space-x-4 px-2 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          <Image
                            src={cart.imageUrl}
                            height={1000}
                            width={1000}
          ...
          <div className="col-span-1 flex flex-col gap-4">
            ...
            <button className="bg-blue-500 rounded-md text-white py-2">
              Check Out
            </button>
          </div>
        </div>
